...
class Record(models.Model):
    ...
    review_people = models.IntegerField(verbose_name='実習担当者について', blank=False, null=True, help_text="0~5", validators=[MinValueValidator(0), MaxValueValidator(5)])
    review_people_comment = models.TextField(verbose_name='', blank=True, null=True, help_text="実習担当者について感じた事・思った事", max_length=1000)
    review_report = models.IntegerField(verbose_name='レポートについて', blank=False, null=True, help_text="0~5", validators=[MinValueValidator(0), MaxValueValidator(5)])
    review_report_comment = models.TextField(verbose_name='', blank=True, null=True, help_text="レポートについて感じた事・思った事", max_length=1000)
    review_communication = models.IntegerField(verbose_name='コミュニケーションについて', blank=False, null=True, help_text="0~5", validators=[MinValueValidator(0), MaxValueValidator(5)])
